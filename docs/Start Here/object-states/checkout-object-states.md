...
The following flowchart details the possible states & substates for checkout transactions:

![3379](https://files.readme.io/01f6c88-yj1XeiukBos.jpg "yj1XeiukBos.jpg")
...
### All Possible Checkout Sub States

| Name                       | Type     | State               | Description                                                                                                                               |
| -------------------------- | -------- | ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| Payment\_Initiated         | subState | Awaiting\_Payment   | Buyer selected the payment method                                                                                                         |
