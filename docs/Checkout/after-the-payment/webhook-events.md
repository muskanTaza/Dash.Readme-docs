...
excerpt: Use webhooks to get notified of offline/asynchronous events
deprecated: false
hidden: false
metadata:
  title: ''
...
{
  "type": "success",
  "body": "Tazapay recommends use of dashboard and status API only for an one-off transaction. For a faster and more-scalable approach, use webhooks."
}
[/block]