...
<Image align="center" className="border" border={true} src="https://files.readme.io/81fb1db-Screenshot_2023-08-14_at_2.23.44_PM.png" />

<Image align="center" className="border" border={true} src="https://files.readme.io/7e80f90-Screenshot_2023-08-14_at_4.47.35_PM.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/0d063cb-image.png" />
...
>
> * <small>Sandbox environment keys will differ from production environment keys. </small>
> * <small>Sign up with Google does **NOT** work on sandbox.</small>