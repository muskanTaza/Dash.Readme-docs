...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        4-letter State code (ISO 3166-2), The state names and code can be accessed from <a href = "https://www.iso.org/obp/ui/#iso:code:3166:US" target="_blank">this list for US</a> and <a href = "https://en.wikipedia.org/wiki/ISO_3166-2:CA" target="_blank">this list for CA</a>
      </td>
