...
excerpt: >-
  ...
  system to a customer's bank account widely used in Mexico.
deprecated: false
hidden: false
metadata:
  title: ''
...
Create a payin on your server with an amount, invoice\_currency `MXN` and a transaction\_description using the [create payin API](https://docs.tazapay.com/reference/create-payin)
