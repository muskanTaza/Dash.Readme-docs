...
title: linkaja_idr
excerpt: >-
  It is a state-owned digital payment platform and e-wallet in Indonesia, formed
  through the consolidation of e-money services from several state-owned
  enterprises (SOEs), including Telkomsel (TCASH), Bank Mandiri (e-cash), and
  BNI (Yap!).
deprecated: false
hidden: false
metadata:
