...
title: ovo_idr
excerpt: >-
  OVO is a prominent digital wallet that offers a wide range of financial and
  lifestyle services. It is the primary payment partner for the **Grab super
  app** in Indonesia and is strongly associated with major retail and shopping
  centers (Lippo Group). It's known for its broad merchant acceptance, loyalty
  points, and strong focus on both online and offline retail payments.
deprecated: false
hidden: true
metadata:
  robots: index
