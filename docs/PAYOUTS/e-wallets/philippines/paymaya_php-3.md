...
title: paymaya_php
excerpt: >-
  Paymaya is a comprehensive digital financial services platform that combines a
  feature-rich e-wallet with a fully licensed digital bank and a crypto trading
  platform. Users can use their virtual/physical card anywhere Visa/Mastercard
  is accepted and earn high interest rates on savings.
deprecated: false
hidden: true
metadata:
  robots: index
...
* **Minimum limits** – PHP 1
* **Maximum limits** – PHP 100,000
...
* **Destination Details**
  ...
  * **Mobile Wallet Type**: `paymaya_php`
  * **Deposit key type**: `phone`
  * **Deposit key**: `+63 XXXXXXXXXX`
* **Reason for Payout**
...
| :------------------- | :------------------------------------ | :------------------------------------------------ | :---------- | :----------------------------------------------------------------------- | :------------------------------- |
| **PH – Philippines** | Mobile Wallet account number (mobile) | Must be a valid Philippine mobile number:`^(?:+63 | 63          | 0)9\d{9}$`Starts with +63/63/0 followed by 9; exactly 10 digits after 9. | `+639171234567` or `09171234567` |

<Callout icon="❌" theme="default">
  ### **Invalid examples:** +638812345678 (wrong for PH)
</Callout>
