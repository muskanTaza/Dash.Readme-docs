...
title: grabpay_php
excerpt: >-
  The mobile wallet service integrated within the Grab super app. It's primarily
  used for seamless, cashless payment of all Grab services (rides, food,
  deliveries) but has expanded to offline and online partner merchants. It is
  highly valued for its GrabRewards loyalty program.
deprecated: false
hidden: true
metadata:
  robots: index
...
* **Destination Details**
  ...
  * **Mobile Wallet Type**: `grabpay_php`
