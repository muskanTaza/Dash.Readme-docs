...
title: shopeepay_php
excerpt: >-
  The mobile wallet arm of the Shopee e-commerce platform. It is essential for
  frictionless and incentivized payments within the Shopee app, offering
  exclusive vouchers and cashback. It is also actively expanding its utility for
  offline payments via QR Ph.
deprecated: false
hidden: true
metadata:
  robots: index
...
* **Destination Details**
  ...
  * **Mobile Wallet Type**: `shopeepay_php`
