...
title: gcash_php
excerpt: >-
  The most widely used mobile wallet in the Philippines, offering a complete
  "super app" experience. It allows users to send/receive money, pay bills, shop
  online/offline via QR Ph, access loans (GLoan), invest (GFunds), and get
  insurance (GInsure), making it an indispensable financial hub.
deprecated: false
hidden: true
metadata:
  robots: index
