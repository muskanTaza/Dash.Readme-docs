---
title: mobile_money_tzs
excerpt: >-
  A vital component of the country's financial landscape, providing access to
  financial services for a significant portion of the population.
deprecated: false
hidden: false
metadata:
  title: ''
...
Tazapay uses a `payin` object to represent your intent to collect a payment from your customer. The payin object tracks state changes from transaction creation to payment completion via mobile money.\
Create a payin on your server with an amount, invoice\_currency `TZS` and a transaction\_description using the [create payin API](https://docs.tazapay.com/reference/create-payin)
