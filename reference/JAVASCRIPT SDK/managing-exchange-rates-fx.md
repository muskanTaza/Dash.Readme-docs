...
next:
  description: ''
---
You can use the [collection methods metadata API](https://docs.tazapay.com/reference/collection-methods-api) to fetch FX rates for a transaction. You can use this FX rate to display the amount that the customer has to pay in their local currency when they select a local payment method on your website.
