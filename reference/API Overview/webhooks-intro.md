...
You don't have to schedule tasks at your end or deploy your resources at polling our endpoints periodically to know of a change in the status of a Tazapay object. Pass a callback\_url in the payload of APIs and Tazapay will notify your server with a POST request of any change in the status of the object. Please make sure to set the callback\_url under HTTPS, else the webhooks would not be triggered!
