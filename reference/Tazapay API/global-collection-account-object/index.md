...
| Type              | Description                                                                                                                                                                                                                                                 |
| :---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| json              | Set of key-value pairs attached to the collection\_account object                                                                                                                                                                                           |
| object            | Consists of all the bank account/wallet details. Please check [virtual\_account](https://docs.tazapay.com/reference/global-collection-account-object#virtual_account), [wallet](https://docs.tazapay.com/reference/global-collection-account-object#wallet) |
| string (ISO Date) | Collection Account creation timestamp                                                                                                                                                                                                                       |
| string (ISO Date) | Collection account last updated timestamp                                                                                                                                                                                                                   |
| string            | Unique identifier (ID) associated with the collection\_account                                                                                                                                                                                              |
| string            | Object structure name - collection\_account in this case.                                                                                                                                                                                                   |
| enum              | Payment Method Type used for the account.                                                                                                                                                                                                                   |
| enum              | Current status of the collection account. It can either be enabled or disabled, enablement\_requested, disablement\_requested.                                                                                                                              |
| array             | List of supported currencies the collection account can receive funds in                                                                                                                                                                                    |
