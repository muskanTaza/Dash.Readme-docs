...
> ❗ Filter Errors
> 
> When you want to include a payment method in a payment URL, do _not_ include this under the filter parameter. The filter function is meant to disable payment methods.
