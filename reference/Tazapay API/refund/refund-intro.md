...
| ------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| txn\_no<br/><small>required</small>   | `String`  Transaction number received from create\_escrow API response                                                                                                                                   |
...
| file\_name | `string`  Name of the file which being uploaded in the above public link |