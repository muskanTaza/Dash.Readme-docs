...
The different types of release\_docs are:

1. When the txn\_type is goods, the value of type can be: `Bill of Lading/ Airway Bill`, `Commercial Invoice`, `Others`
2. When the txn\_type is service, the value of type can be: `Invoice`, `Proof of Service Delivery`, `Others`
