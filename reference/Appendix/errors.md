...
{
  "type": "info",
  "body": "4xx status codes carry <a href = \"https://tazapay-api-developer.readme.io/reference/users-2\" target=\"_blank\">error codes</a> which explain in brief the reason the request failed to perform the operation."
}
[/block]
### HTTP Status Codes:
| Error Code | Meaning                                                                                                                                                                                   |
